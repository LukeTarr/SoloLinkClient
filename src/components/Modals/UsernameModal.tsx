...
const CategoryModal = (props: UsernameModalProps) => {
    ...
    const editUsernameMutation = useMutation("editCategory", editUsername, {
        onSettled: (res) => {
            // Custom Error
            if (res?.error) {
                setError(res.error);
    ...
    async function editUsername(): Promise<LoginDTO> {
        let res;
        try {
            res = await fetch(
                `${import.meta.env.VITE_SOLOLINK_API}/Auth/ChangeUsername`,
                {
                    method: "PUT",
                ...
                <div
                    ...
                    <div className="bg-gray-50 px-4 py-3 sm:px-6 sm:flex items-center justify-center">
                        ...
                        <button
                            ...
                            onClick={() => {
                                editUsernameMutation.mutateAsync();
                            }}
                        >
                            Save
                        </button>
